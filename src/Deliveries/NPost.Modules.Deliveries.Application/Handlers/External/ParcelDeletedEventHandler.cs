...
{
    internal class ParcelDeletedEventHandler : IIntegrationEventHandler<ParcelDeleted>
    {
        private readonly IParcelsRepository _parcelsRepository;
        private readonly ILogger<ParcelDeleted> _logger;

        public ParcelDeletedEventHandler(IParcelsRepository parcelsRepository, ILogger<ParcelDeleted> logger)
        {
